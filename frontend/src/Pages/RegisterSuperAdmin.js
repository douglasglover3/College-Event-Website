...
export default function RegisterSuperAdmin({setUser}) {
    ...
    {
        if(validateInputs())
            Axios.post(API_URL + "/users/createSuperAdmin", {
                userID: userID,
    ...
    return (
        <div>
            <Section color="white">
                <div style={{width:"70%"}}>
                    <h4 style={{marginBottom:"30px"}}>Register as a Super Admin</h4>
                        ...
                        <Button className="regular" type="button" onClick={() => registerSuperAdmin()}>
                            Register
                        </Button>
                </div>
            </Section>
